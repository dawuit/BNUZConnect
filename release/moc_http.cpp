...
QT_MOC_LITERAL(4, 47, 5) // "reply"
    ...
    "HttpAPI\0serviceRequestFinished\0\0"
...
void HttpAPI::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        HttpAPI *_t = static_cast<HttpAPI *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject HttpAPI::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_HttpAPI.data,
      qt_meta_data_HttpAPI,  qt_static_metacall, nullptr, nullptr}
};
